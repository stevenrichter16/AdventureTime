    ...
    Guidelines for dialogue extraction:
    - signatureLines: Choose 3-6 lines per major character that best capture their personality, emotional state, or growth in this episode
    - keyDialogue: Select the ONE line that most powerfully represents each story beat
    - notableQuotes: Include 2-4 quotes that make each key moment emotionally impactful
