...
{
    Task<EpisodeAnalysis> AnalyzeEpisodeAsync(Episode episode, ContinuityContext context, CancellationToken cancellationToken = default) => AnalyzeEpisodeAsync(episode, cancellationToken);
